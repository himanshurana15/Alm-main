...
const AdminAccountCreate = () => {
  ...
  <div className="w-full max-w-lg">
    ...
    <div className="flex items-center gap-2 p-4 mb-4">
      ...
      <span className="text-[20px] md:text-[24px] font-semibold">Rhombus</span>
    </div>
    ...
    <div className="flex items-center gap-3 w-full max-w-[350px] px-4 py-3 border border-[#107A2B] rounded-lg bg-[rgba(52,199,89,0.24)]">
      ...
      <div className="md:w-1/2 w-full h-auto bg-white lg:w-1/2 p-6  flex flex-col items-center rounded-lg shadow-md">
